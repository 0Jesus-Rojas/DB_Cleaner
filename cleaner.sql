...
/*Reto F - Retorna un listado con el nombre de los todos los clientes españoles.*/
...
/*Reto H - Genera un listado con el código de cliente de aquellos clientes que realizaron algún pago en 2008.
